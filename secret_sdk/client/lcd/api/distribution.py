...
from secret_sdk.core import AccAddress, Coins, ValAddress
...
class AsyncDistributionAPI(BaseAsyncAPI):
    ...
    async def validator_outstanding_rewards(self, validator_address: ValAddress,  params: Optional[APIParams] = None) -> ValidatorOutstandingRewards:
        """Fetches validator outstanding rewards.
                ...
                Returns:
                    ValidatorOutstandingRewards: delegator rewards
                """
        res = await self._c._get(
        ...
        return ValidatorOutstandingRewards(
            rewards=Coins.from_data(res["rewards"]['rewards'] or [])
        )
...
class DistributionAPI(AsyncDistributionAPI):
    ...
    def validator_outstanding_rewards(self, validator_address: ValAddress, params: Optional[APIParams] = None) -> ValidatorOutstandingRewards:
        pass
