...
class Result(betterproto.Message):
    ...
    msg_responses: List[protobuf.Any] = betterproto.message_field(4)
...
class TxMsgData(betterproto.Message):
    ...
    # cosmos-sdk 0.46
    msg_responses: List[protobuf.Any] = betterproto.message_field(2)
...
class SearchBlocksResult(betterproto.Message):
    ...
    blocks: List[types.Block] = betterproto.message_field(6)
