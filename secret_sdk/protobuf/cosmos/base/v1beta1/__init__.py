...
class IntProto(betterproto.Message):
    """
    IntProto defines a Protobuf wrapper around an Int object. Deprecated:
    Prefer to use math.Int directly. It supports binary Marshal and Unmarshal.
    """
...
class DecProto(betterproto.Message):
    """
    DecProto defines a Protobuf wrapper around a Dec object. Deprecated: Prefer
    to use math.LegacyDec directly. It supports binary Marshal and Unmarshal.
    """
