...
# sources: cosmos/mint/v1beta1/mint.proto, cosmos/mint/v1beta1/tx.proto, cosmos/mint/v1beta1/genesis.proto, cosmos/mint/v1beta1/query.proto
...
class MsgStub(betterproto.ServiceStub):
    ...
    async def update_params(
        ...
        module parameters. The authority is defaults to the x/gov module
        account. Since: cosmos-sdk 0.47
        """
