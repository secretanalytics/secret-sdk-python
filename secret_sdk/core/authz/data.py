...
from secret_sdk.protobuf.cosmos.authz.v1beta1 import (
    GenericAuthorization as GenericAuthorization_pb,
)
from secret_sdk.protobuf.cosmos.authz.v1beta1 import Grant as Grant_pb
from secret_sdk.protobuf.cosmos.bank.v1beta1 import SendAuthorization as SendAuthorization_pb
from secret_sdk.protobuf.cosmos.staking.v1beta1 import AuthorizationType
...
from secret_sdk.core import AccAddress, Coin, Coins
from secret_sdk.util.base import BaseSecretData
from secret_sdk.util.converter import to_isoformat
...
class Authorization(BaseSecretData):
    """Base class for authorization types."""

    @staticmethod
    def from_amino(amino: dict) -> Authorization:
        from secret_sdk.util.parse_authorization import parse_authorization_amino

        return parse_authorization_amino(amino)

    @staticmethod
    def from_data(data: dict) -> Authorization:
        from secret_sdk.util.parse_authorization import parse_authorization

        return parse_authorization(data)

    @staticmethod
    def from_proto(proto: Any_pb) -> Authorization:
        from secret_sdk.util.parse_authorization import parse_authorization_proto

        return parse_authorization_proto(proto)

    @staticmethod
    def unpack_any(proto: Any_pb) -> Authorization:
        from secret_sdk.util.parse_authorization import parse_authorization_unpack_any
...
class SendAuthorization(Authorization):
    """Type of :class:`Authorization` for :class:`MsgSend<secret_sdk.core.bank.msgs.MsgSend>`,
