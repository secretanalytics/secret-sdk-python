...
import attr
from secret_sdk.protobuf.cosmos.gov.v1beta1 import MsgDeposit as MsgDeposit_pb
from secret_sdk.protobuf.cosmos.gov.v1beta1 import MsgSubmitProposal as MsgSubmitProposal_pb
from secret_sdk.protobuf.cosmos.gov.v1beta1 import MsgVote as MsgVote_pb
...
class MsgSubmitProposal(Msg):
    ...
    def from_data(cls, data: dict) -> MsgSubmitProposal:
        from secret_sdk.util.parse_content import parse_content
    ...
    def from_proto(cls, proto: MsgSubmitProposal_pb) -> MsgSubmitProposal:
        from secret_sdk.util.parse_content import parse_content_unpack_any
